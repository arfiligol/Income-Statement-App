from application.ports.repositories import LawyerRepository
from domain.dto.lawyer import Lawyer
from infrastructure.db.lawyer import Lawyer as DbLawyer
