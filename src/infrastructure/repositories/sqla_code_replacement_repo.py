from application.ports.repositories import CodeReplacementRepository
from domain.dto.code_replacement import CodeReplacement
from infrastructure.db.code_replacement import DbCodeReplacement
