...
from income_statement_app.services.update_manager import UpdateManager
from income_statement_app.ui.components.dialogs.update_dialog import UpdateDialog
from income_statement_app.ui.state.app_store import AppStore
...
def app_shell(content_builder: Callable):
    ...
    with ui.left_drawer(value=False).classes(
        ...
        with ui.column().classes("w-full gap-2 p-4"):
            ...
            ui.space()
            from income_statement_app.common.version import __version__
