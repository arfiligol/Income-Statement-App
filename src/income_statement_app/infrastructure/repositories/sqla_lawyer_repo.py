from income_statement_app.application.ports.repositories import LawyerRepository
from income_statement_app.domain.dto.lawyer import Lawyer
from income_statement_app.infrastructure.db.lawyer import Lawyer as DbLawyer
